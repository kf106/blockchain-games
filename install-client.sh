...
# There seems to be a venv cross-contamination between bank and client
# so each needs its own venv
# this creates a copy of the python3 environment in a folder called venv-client
